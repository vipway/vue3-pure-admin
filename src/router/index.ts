...
const add: Array<RouteItem> = [
	{
		...
		children: [
			...
			},
			{
				...
				component: () => import('../views/example/nested'),
				children: [
					{
						path: '/nested/menu-1',
						name: 'nested/menu-1',
						meta: { title: '菜单 2-1' },
						component: () => import('../views/example/Menu1')
					},
					{
						path: '/nested/menu-2',
						name: 'nested/menu-2',
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								meta: { title: '菜单 3-2' },
								component: () => import('../views/example/Menu2')
							},
						]
					},
					{
					...
					},
					{
						...
						name: 'nested/menu-3',
						meta: { title: '菜单 2-3' },
						component: () => import('../views/example/Menu3')
					}
				]
			},
			{
				...
				component: () => import('../views/example/Menu4')
			}
		]
	},
	{
		...
		children: [
			...
			},
			{
				...
				meta: { title: '自定义组件' },
				component: () => import('../views/custom-components')
			},
			{
				path: '/example/tsx',
				name: 'example-tsx',
