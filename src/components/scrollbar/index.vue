    ...
    function updateThumbStyle() {
      ...
      if (wrapEl) {
        if (props.vertical) {
          ...
          thumbStyle.transform = `translate3d(0, ${(wrapEl.scrollTop / wrapEl.scrollHeight) *
            wrapEl.clientHeight}px, 0)`
        } else {
          ...
          thumbStyle.transform = `translate3d(${(wrapEl.scrollLeft / wrapEl.scrollWidth) *
            wrapEl.clientWidth}px, 0, 0)`
          // console.log("------------------------------------");
        }
      }
